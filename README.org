...
- [ ] functional tests
- [ ] contract testing
- [ ] start node needs to take validated inputs to enter into flowstate
- [ ] api node needs to validate whatever it wants to store into flowstate
- [ ] dynamic validation system for the above two
- [ ] fastapi endpoint for starting workflow should take a dict of state for start
- [ ] interactive node
- [ ] GUI to configure/build
- [ ] GUI Dashboard
- [ ] CLI?

- [ ] Try individual query files and/or directories (edgedb-py doesn't innately do different directories)
- [ ] Validation on Start Requirements
